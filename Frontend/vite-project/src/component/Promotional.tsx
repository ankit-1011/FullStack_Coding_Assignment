...
export default function Promotional() {
    return (
        <div className="md:grid md:grid-cols-2 max-w-4xl bg-gray-300 m-23 h-96 md:mx-auto rounded-xl">
            <img src="https://tse1.mm.bing.net/th/id/OIP.pKopVfadNB3axQUAoC7CGQHaFI?rs=1&pid=ImgDetMain&o=7&rm=3"
                alt="promotional" className="hidden md:block w-full max-w-lg rounded-l-xl h-96"  />
            <div className="relative flex items-center justify-center">
                ...
                <div className="max-md:py-20 px-6 md:px-10 text-center">
                    ...
                    <button className="rounded-lg bg-blue-600  active:bg-blue-800 text-sm px-14 py-3 mt-4 text-white">
